...
/**
 * Created by Laptop on 3/25/2017.
 */
...
public class BadgeDrawable extends Drawable {
    ...
    public BadgeDrawable(Context context) {
        ...
        mBadgePaint.setColor(ContextCompat.getColor(context.getApplicationContext(), R.color.badge));
        mBadgePaint.setAntiAlias(true);
        mBadgePaint.setStyle(Paint.Style.FILL);
        mBadgePaint1 = new Paint();
        mBadgePaint1.setColor(ContextCompat.getColor(context.getApplicationContext(), R.color.badge));
