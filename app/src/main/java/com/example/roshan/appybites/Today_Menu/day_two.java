...
public class day_two extends AppCompatActivity{
    private String mNotifCount= String.valueOf(0);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDb = new DbHandler(day_two.this);
    ...
    private class JsonTask extends AsyncTask<String, Void, String> {
        ProgressDialog pdLoading = new ProgressDialog(day_two.this);
        ...
        protected void onPostExecute(String jsonStr) {
            ...
            if (jsonStr != null) {
                try {
                    ...
                    mAdapter = new Today_Menu_Adapter(day_two.this, catering_items);
